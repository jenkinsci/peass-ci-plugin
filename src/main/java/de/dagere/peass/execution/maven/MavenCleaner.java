...
public class MavenCleaner {
   ...
   public MavenCleaner(final PeassFolders folders, final EnvironmentVariables env) {
      System.out.println("Using debug MavenCleaner of Peass-CI on windows");
   ...
   private ProcessBuilder buildProcess(final File logFile) {
      ...
      System.out.println("Executing on " + folders.getProjectFolder() + " Exists: " + folders.getProjectFolder().exists());
      System.out.println("Files: ");
      for (File file : folders.getProjectFolder().listFiles()) {
