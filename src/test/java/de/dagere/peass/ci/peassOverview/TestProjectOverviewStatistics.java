...
public class TestProjectOverviewStatistics {
   ...
   private ProjectChanges buildChanges() {
      ...
      changes.addChange(new TestCase("TestA#test"), VERSION_1, new Change());
      changes.addChange(new TestCase("TestB#test"), VERSION_1, new Change());
      changes.addChange(new TestCase("TestC#test"), VERSION_1, new Change());
      
      changes.addChange(new TestCase("TestA#test"), VERSION_2, new Change());
      changes.addChange(new TestCase("TestB#test"), VERSION_2, new Change());
      changes.addChange(new TestCase("TestC#test"), VERSION_2, new Change());
      
      changes.addChange(new TestCase("TestA#test"), VERSION_3, new Change());
      changes.addChange(new TestCase("TestB#test"), VERSION_3, new Change());
      return changes;
   }
}
