...
public class TestRTSLogSummary {
   ...
   public void testFineResult() {
      ...
      rtsVmRuns.put(new TestCase("TestMe#test"), new RTSLogData(null, null, null, success, false));
      rtsVmRunsPredecessor.put(new TestCase("TestMe#test"), new RTSLogData(null, null, null, success, false));
